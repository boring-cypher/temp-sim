...
public class CharacterTest {
    ...
    public void SetNegativeSocial() {
        ...
        c.setSocial(-1);
        Assert.assertEquals(0, c.getSocial());
    }
    ...
    @Test
    public void testSocialiseCapsAt100() {
        sims.character.Character c = new sims.character.Character("Sam", "Male",  95, 10, 5);
        c.socialise();
        Assert.assertEquals(100, c.getHappiness());
    }
    ...
    @Test
    public void testSetKnowledgeCaps() {
        sims.character.Character c = new sims.character.Character("Sam", "Male",  50, 10, 5);
        c.setKnowledge(101);
        Assert.assertEquals(100, c.getKnowledge());
        c.setKnowledge(-1);
        Assert.assertEquals(0, c.getKnowledge());
    }

    @Test
    public void testSetHappinessCaps() {
        sims.character.Character c = new sims.character.Character("Sam", "Male",  50, 10, 5);
        c.setHappiness(101);
        Assert.assertEquals(100, c.getHappiness());
        c.setHappiness(-1);

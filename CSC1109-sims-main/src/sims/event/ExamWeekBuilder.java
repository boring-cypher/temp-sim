...
public class ExamWeekBuilder {
    ...
    public static ArrayList<Events> buildExamEvents() {
        ArrayList<Events> examEvents = new ArrayList<>();
    ...
    private static void add(List<Events> events, String id, int turn, String category, String title,
        ...
        events.add(new Events(id, "main", turn, Phase.EXAM, category, title, desc, mood, npcs, new ArrayList<>(List.of(choices)), null));
    }

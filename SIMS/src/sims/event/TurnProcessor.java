...
public class TurnProcessor {
    ...
    protected void applyChoice(
        ...
        // new: set story branch if this choice defines one
    ...
    protected static EventChoice selectChoice(Events selectedEvent, TurnState turnState, Character character) {
        ...
        for (int i = 0; i < choices.size(); i++) {
            ...
            System.out.println((i + 1) + ") " + c.getDescription() + " [Energy: " + c.getEnergyCost() + costDisplay + "]");
        }
    ...
    protected static int chooseCategory(List<String> categories, Character character, int energyLeft, int maxEnergy) {
        System.out.println("\nChoose a category:");

...
public class EventChoice {
    ...
    private final List<Branch> branches;   // fixed: Branch, not String
    private final List<NPC> affectedNPCs;
    private final NPCAction action;

    // new: branch route setter for your main story
    ...
    public List<Branch> getBranches() {   // fixed: Branch, not String
        return branches;
    }
